...
class DataVisualizerUI(Component):
    ...
    def _render_overview(self, df):
        ...
        overview = DataVisualizer.generate_overview(df)
        st.dataframe(overview)

    def _render_visualization_options(self, df):
        """
        ...
        # Custom Line Plot
        selected_plot_cols = st.multiselect("Select Columns for Line Plot", numeric_cols)
        ...
        selected_heatmap_cols = st.multiselect("Select Columns for Correlation Heatmap", numeric_cols)
        ...
        # Custom Histograms
        selected_hist_cols = st.multiselect("Select Columns for Histograms", numeric_cols)
